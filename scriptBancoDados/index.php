...
('Cacto rabo de macaco', '../imagens/cacto-rabo-de-macaco.png', 79.90, 'O cacto rabo-de-macaco é uma planta exótica e ornamental que conquista pela sua aparência única e floração vibrante. Com hastes longas, pendentes e cobertas por espinhos finos e brancos que lembram pelos, essa espécie é perfeita para vasos suspensos, jardins verticais e ambientes que pedem um toque selvagem e elegante.
...
('Substrato','../imagens/substrato.png', 29.99, 'Garanta o melhor cuidado para suas plantas com o substrato ideal para cactos e suculentas. Desenvolvido com uma fórmula balanceada, esse substrato oferece alta drenagem, excelente aeração e nutrição sob medida, evitando o excesso de umidade que pode comprometer a saúde das raízes.
...
('Suculenta rabo de burro','../imagens/suculenta-rabo-de-burro.png', 5.90, 'A suculenta Rabo-de-Burro é uma verdadeira joia do mundo vegetal. Com hastes longas e pendentes cobertas por folhas carnudas e verde-azuladas, essa planta cria um efeito cascata exuberante que transforma qualquer ambiente em um espaço mais leve e sofisticado. Ideal para vasos suspensos, arranjos verticais ou decorações internas com estilo natural e moderno.
